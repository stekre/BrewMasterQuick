    ...
    backspaceKeyPanel: KeyPanel {
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: "images/backspace-868482.svg"
            }
        }
        states: [
            State {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: {
                    ...
                    case EnterKeyAction.Next:
                    case EnterKeyAction.Done:
                        return "images/check-868482.svg"
                    case EnterKeyAction.Search:
                        return "images/search-868482.svg"
                    default:
                        return "images/enter-868482.svg"
                    }
                }
            }
            Text {
    ...
    shiftKeyPanel: KeyPanel {
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: "images/shift-868482.svg"
            }
            states: [
                State {
                    name: "capslock"
                    ...
                    PropertyChanges {
                        target: shiftKeyIcon
                        source: "images/shift-c5d6b6.svg"
                    }
                },
                State {
                    name: "shift"
                    ...
                    PropertyChanges {
                        target: shiftKeyIcon
                        source: "images/shift-80c342.svg"
                    }
                }
            ]
        }
    ...
    handwritingKeyPanel: KeyPanel {
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: (keyboard.handwritingMode ? "images/textmode-868482.svg" : "images/handwriting-868482.svg")
            }
        }
        states: [
            State {
